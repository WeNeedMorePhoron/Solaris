...
//vampire mistform here
/mob/living/simple_animal/hostile/retaliate/vampiregaseousform/Initialize()
	. = ..()
	set_light(1, 1, 2)
	ADD_TRAIT(src, TRAIT_NOFALLDAMAGE2, MAGIC_TRAIT)
	addtimer(CALLBACK(src, TYPE_PROC_REF(/mob/living/simple_animal/hostile/retaliate/vampiregaseousform, revert), "Mist"), 10 SECONDS)


/mob/living/simple_animal/hostile/retaliate/vampiregaseousform/proc/revert()
	REMOVE_TRAIT(src, TRAIT_NOFALLDAMAGE2, MAGIC_TRAIT)
	qdel()

/mob/living/simple_animal/hostile/retaliate/vampiregaseousform/Move(NewLoc, direct)
	var/oldloc = loc
